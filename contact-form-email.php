...
class ThinkContactForm{
    ...
    return $wpsf_settings;
		...
		echo '<form role="form" id="cf-email" action="'. plugin_dir_url(__FILE__).'emailSubmit.php" method="post"><br />';
		echo '<div class="form-group"><input type="text" class="form-control" name="name" size="30" placeholder="Ім\'я"></div>';
		echo '<div class="form-group"><input type="text" class="form-control" name="email" size="30" placeholder="Email"></div>';
		echo '<div class="form-group"><input type="text" class="form-control" name="phone" size="30" placeholder="Teлефон"></div>';
		//echo 'Subject:<br /><input type="text" name="subject" size="30"><br />';
		echo '<div class="form-group"><textarea name="message" class="form-control" rows="6">Введіть текст повідомлення:</textarea></div>';
		...
		echo '<div class="form-group"><input type="submit" value="Відіслати"></div>';
		echo '</form>';
